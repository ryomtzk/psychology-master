...
PsychApp.registerModule({
  ...
  lessons: [
    ...
    },
    {
      ...
      body: `
        ...
        <p>その極端な例が、Quiroga らがヒトの<strong>内側側頭葉（medial temporal lobe）</strong>で記録した<strong>概念選択的細胞</strong>である。ある細胞は、ある有名人の様々な写真（別アングル・別の場面）に共通して応答した。報道で「<strong>ジェニファー・アニストン・ニューロン</strong>」と呼ばれたこの所見は、抽象的な概念に対応した不変的な表現の存在を示唆する。別の細胞（「<strong>ハル・ベリー・ニューロン</strong>」）は、写真や似顔絵だけでなく<strong>書かれた名前</strong>にも応答し、概念がモダリティを超えて表現されうることを示した。ただしこれは1細胞=1概念の祖母細胞説の証明ではなく、まばらだが分散した符号化と解釈される。</p>
        <h3>顔認識の特殊性</h3>
      ...
      terms: [
        ...
        { term: "概念選択的細胞 / ジェニファー・アニストン・ニューロン", def: "内側側頭葉で特定の人物の様々な写真に共通して応答した細胞（Quirogaら）。別の細胞は書かれた名前にも応答し、抽象的概念の不変表現を示唆。" },
  ...
  questions: [
    ...
    { type: "mcq", stem: "Quirogaらがヒト内側側頭葉で記録し、特定の人物の様々な写真に共通して応答した（概念選択的な）細胞は俗に何と呼ばれたか。", choices: ["ミラーニューロン", "ジェニファー・アニストン・ニューロン", "場所細胞", "グリッド細胞"], answer: 1, explain: "報道で「ジェニファー・アニストン・ニューロン」と呼ばれた概念選択的細胞である。抽象的概念の不変的表現を示唆するが、まばらな分散符号化と解釈される。", difficulty: 2 },
