...
PsychApp.registerModule({
  ...
  lessons: [
    ...
    },
    {
      ...
      body: `
        ...
        <h3>意識の神経相関</h3>
        <p><strong>意識の神経相関（neural correlates of consciousness, NCC）</strong>は、特定の意識的経験に対して十分な最小の神経過程を指す。<em>クリックとコッホ（Crick & Koch）</em>がこの探求を科学の俎上に載せた。両眼視野闘争やマスキングは、刺激ではなく「報告される見え」と連動する活動を探すための実験パラダイムである。</p>
      ...
      terms: [
        ...
        { term: "意識の神経相関（NCC）", def: "特定の意識経験に対して十分な最小の神経過程（Crick & Koch）。" },
  ...
  questions: [
    ...
    { type: "mcq", stem: "「意識の神経相関（NCC）」という概念を科学的探求の俎上に載せた研究者の組み合わせはどれか。", choices: ["ヒューベルとウィーゼル", "クリックとコッホ（Crick & Koch）", "ギブソンとウォーク", "メルザックとウォール"], answer: 1, explain: "クリックとコッホは、意識的経験に対して十分な最小の神経過程（NCC）の探求を科学の課題として提起した。", difficulty: 2 },
