  ...
  lessons: [
    ...
    },
    {
      ...
      body: `
        ...
        <div class="callout note">交感神経の終末では<strong>ノルアドレナリン</strong>が神経伝達物質として、副腎髄質からは<strong>アドレナリン</strong>がホルモンとして血中に放出される。両者は同じカテコールアミンの仲間であり、神経系と内分泌系がいかに連続的かを示す例である。</div>
      `,
      ...
      terms: [
        ...
        { term: "アドレナリン", def: "副腎髄質からホルモンとして血中に放出され心拍等を急上昇させる。交感神経の終末では代わりにノルアドレナリンが神経伝達物質として働く。" },
