  ...
  lessons: [
    ...
    },
    {
      ...
      body: `
        ...
        <h4>ボボ人形実験（Bobo doll experiments, 1961・1965）</h4>
        <p>子どもたちに、大人が空気人形（ボボ人形）を叩く・蹴る・乱暴な言葉を浴びせる様子を見せた。その後、同じ部屋に入れると、子どもたちは見た通りの攻撃行動を<strong>模倣</strong>した。攻撃しなかった大人を見た群や統制群より明らかに攻撃的だった（1961年の原実験）。さらに後続の実験（1965）では、大人の攻撃が<strong>褒められた</strong>のを見た子は模倣しやすく、<strong>罰せられた</strong>のを見た子は模倣しにくかった。後者で「やればできるが、やらなかった」ことは、報酬を提示すると模倣が現れることで確認された（<strong>代理強化／代理罰</strong>、ここでも学習と遂行の区別が表れる）。</p>
