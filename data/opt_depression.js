...
PsychApp.registerModule({
    ...
    },
    {
      ...
      body: `
        ...
        <table>
          ...
          <tr><td><strong>自己報告式</strong>の抑うつ尺度</td><td>+.16（むしろ逆方向）</td></tr>
          <tr><td><strong>構造化面接</strong>による診断</td><td>−.04</td></tr>
        </table>
  ...
  questions: [
    ...
    { type: "mcq", stem: "Moore & Fresco(2012)のメタ分析で、抑うつリアリズム効果が『出やすかった』研究の特徴はどれか。", choices: ["客観的基準をもち、構造化面接で診断した研究", "客観的基準を欠き、自己報告式の抑うつ尺度を用いた研究", "大標本で事前登録された研究", "fMRIを用いた研究"], answer: 1, explain: "客観的基準を欠く研究(d=−.15 vs 基準ありで−.03)や自己報告式尺度を用いた研究(d=.16 vs 構造化面接で−.04)で効果が出やすく、方法論的人工産物の可能性が示唆された。", difficulty: 3 },
