  ...
  lessons: [
    {
      ...
      body: `
        ...
        <ul>
          ...
          <li><strong>危険行動（health-risk behavior）</strong>：喫煙、過度の飲酒、運動不足、不健康な食事、危険運転など。<em>ブレスローとベロック</em>の研究（アラメダ郡研究）では、7つの健康習慣（喫煙しない・適正体重・規則的運動・適度な飲酒・7〜8時間睡眠・朝食をとる・間食をしない）が寿命と関連することが示された。</li>
        </ul>
